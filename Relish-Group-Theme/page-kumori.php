	...
	<div class="kumori-menu">
		<div class="menu-item bg-light-grey" style="background: url(images/menu/AppleBun.jpg)"><p class="imgDescription">Apple Bun</p></div><div class="menu-item bg-dark-grey" style="background: url(images/menu/CheesyHam&MushroomBun.jpg)"><p class="imgDescription">Cheesy Ham &amp;Mushroom Bun</p></div><div class="menu-item bg-light-grey" style="background: url(images/menu/KadawariCreamBun.jpg)"><p class="imgDescription">Kadawari Cream Bun</p></div><div class="menu-item bg-dark-grey" style="background: url(images/menu/KroneHR.jpg)"><p class="imgDescription">Krone HR</p></div><div class="menu-item bg-light-grey" style="background: url(images/menu/LightDoubleCheesecake.jpg)"><p class="imgDescription">Light Double Cheesecake</p></div><div class="menu-item bg-dark-grey" style="background: url(images/menu/NamaChocoSand.jpg)"><p class="imgDescription">Nama Choco Sand</p></div><div class="menu-item bg-light-grey" style="background: url(images/menu/ParmesanCreamBun.jpg)"><p class="imgDescription">Parmesan Cream Bun</p></div><div class="menu-item bg-dark-grey" style="background: url(images/menu/PeachBrioche.jpg)"><p class="imgDescription">Peach Brioche</p></div><div class="menu-item bg-light-grey" style="background: url(images/menu/RedBeanBun.jpg)"><p class="imgDescription">Red Bean Bun</p></div><div class="menu-item bg-dark-grey" style="background: url(images/menu/SignatureHanjukuCheese.jpg)"><p class="imgDescription">Signature Hanjuku Cheese</p></div><div class="menu-item bg-light-grey" style="background: url(images/menu/TofuCheesecake.jpg)"><p class="imgDescription">Tofu Cheesecake</p></div><div class="menu-item bg-dark-grey" style="background: url(images/menu/ToyohashiPudding.jpg)"><p class="imgDescription">Toyohashi Pudding</p></div>
	</div>
	...
	<div class="kumori-branches">
		<div class="row limit">
			<div class="four columns">
				<p class="item-name">SM Makati</p>
				<p class="item-desc">Lower Ground Floor<br/>(+63) 917-569430</p>
			</div>
			<div class="four columns">
				<p class="item-name">Landmark Makati</p>
				<p class="item-desc">Lower Ground Floor<br/>(+63) 917-6569430</p>
			</div>
			<div class="four columns">
				<p class="item-name">SM North EDSA</p>
				<p class="item-desc">The Block<br/>Opening December 2015</p>
			</div>
		</div>
