	...
	<footer>
		<div class="row limit">
			<div class="three columns">
				<img class="footer-details" src="<?php bloginfo('template_directory'); ?>/images/relish-footer-logo.jpg" />
			</div>
...
<script src="<?php bloginfo('template_directory'); ?>/js/weenamkee.js" charset="utf-8"></script>
