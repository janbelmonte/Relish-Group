...
<head>
  ...
  –––––––––––––––––––––––––––––––––––––––––––––––––– -->
  <meta charset="utf-8">
  <title>Osaka Ohsho - A Relish Group Brand</title>
  <meta name="description" content="Osaka Ohsho is Japan’s #1 restaurant specializing in Gyoza, together with a host of other staple Japanese dishes.">
  <meta property="og:image" content="http://www.relish-group.com/img/og-osaka.jpg" />
  ...
  <link rel="stylesheet" href="<?php bloginfo('template_directory');?>/css/osakaohsho.css">
  	...
  	<nav class="nav-collapse">
  		<div id="menu-center" class="limit">
			...
			<ul class="navi__list">
			    ...
			    <li class="navi__listItem"><a href="#osaka-branches">Branches</a></li>
			</ul>
		</div>
	</nav>
